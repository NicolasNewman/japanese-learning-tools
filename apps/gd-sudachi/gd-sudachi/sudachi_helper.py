...
def get_english_pos(token):
    ...
    results = {
        ...
        'pos_subcategory1': pos2_mapping.get(pos_tuple[1], pos_tuple[1]) if pos_tuple[1] else 'NULL',
        'pos_subcategory2': pos3_mapping.get(pos_tuple[2], pos_tuple[2]) if pos_tuple[2] else 'NULL',
        'pos_subcategory3': pos4_mapping.get(pos_tuple[3], pos_tuple[3]) if pos_tuple[3] else 'NULL',
        'conjugation_type': conj_type_mapping.get(pos_tuple[4], pos_tuple[4]) if pos_tuple[4] else 'NULL',
        'conjugation_form': conj_form_mapping.get(pos_tuple[5], pos_tuple[5]) if pos_tuple[5] else 'NULL'
    }
