...
1. Automatically copy subtitles from supported streaming services directly to your clipboard (which triggers an automatic search in GoldenDict)
    - Supported services: Jellyfin
2. Highlight Kanji on a webpage based on the stages in supported SRS programs
...
A desktop application which handles seting up gd-tools/subs2clipboard on installation and syncs up your SRS' with subs2clipboard